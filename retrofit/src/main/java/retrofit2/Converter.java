...
public interface Converter<F, T> {
  ...
  abstract class Factory {
     ...
     * declaration.
     */
    @Nullable public  Converter<ResponseBody, ?> responseBodyConverter(
     ...
     */
    @Nullable public  Converter<?, RequestBody> requestBodyConverter(
        Type type,
     ...
     */
    @Nullable public  Converter<?, String> stringConverter(
        Type type, Annotation[] annotations, Retrofit retrofit) {
      return null;
    }
